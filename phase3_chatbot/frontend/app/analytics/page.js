...
import { PaperAirplaneIcon, ChartBarIcon, SparklesIcon } from '@heroicons/react/24/outline';
...
export default function AnalyticsPage() {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      content: "Welcome to the Analytics page! Here you can view insights and statistics about your productivity.",
      role: "assistant",
