...
import { PaperAirplaneIcon, BellIcon, SparklesIcon } from '@heroicons/react/24/outline';
...
export default function NotificationsPage() {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      content: "Welcome to the Notifications page! Here you can manage your alerts and notifications.",
      role: "assistant",
